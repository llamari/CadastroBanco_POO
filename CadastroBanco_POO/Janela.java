...
public class Janela extends JFrame {
    ...
    private void addObjects() {
        ...
        Buttons buttons = new Buttons(this::onConsult, this::onUpdate, this::onCreate);
        ...
        new Timer(100, e -> {
            if (!forms.isFormValid()) {
                buttons.getJbUpdate().setEnabled(false);
            } else {
                buttons.getJbUpdate().setEnabled(true);
            }
        }).start();
    }
    ...
    private void onCreate() {
        ...
        functions.addAccount(agencyNumber, accountNumber, name, adress, phone, cpf, type);
    }
